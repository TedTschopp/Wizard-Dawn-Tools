...
if ($menu_section == 3)
{
	...
	echo "<p style='font-size:" . round(35 * $font_size_adjust_main) . "px; font-family: WizardawnTitle; line-height: 40px; width:600px; margin-top: 0; margin-bottom: 0'>&nbsp;7th Edition</p>";
